...
No dependency on the old divide_and_conquer directory beyond reusing its
config/weights and custom model heads.  The custom heads are registered by
importing the local .modeling package of the old divide_and_conquer directory.
"""
